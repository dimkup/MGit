...
public final class RepoContract {
    ...
    public static abstract class RepoEntry implements BaseColumns {
        ...
        public static final String COLUMN_NAME_MTLS_KEY_ALIAS = "mtls_key_alias";
    ...
    public static final String REPO_ENTRY_CREATE = "CREATE TABLE "
            ...
            + COMMA_SEP + RepoEntry.COLUMN_NAME_MTLS_KEY_ALIAS + TEXT_TYPE
            + " )";
    ...
    public static String getMtlsKeyAlias(Cursor cursor) {
